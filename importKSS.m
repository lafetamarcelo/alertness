...
%
%    C:\Users\marce\Desktop\Projets\realData_work\KSS.csv
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2019/04/03 17:55:56

%% Initialize variables.
%filename = 'C:\Users\marce\Desktop\Projects\realData_work\KSS.csv';
filename = '/home/marcelo/Documents/Projects/alertness_dB/KSS.csv';
delimiter = ',';
startRow = 2;
...
data = dates{:, 1};
hora = dates{:, 2};
horadec = cell2mat(rawNumericColumns(:, 1));
kss = cell2mat(rawNumericColumns(:, 2));
...
clearvars filename delimiter startRow formatSpec fileID dataArray ans raw col numericData rawData row regexstr result numbers invalidThousandsSeparator thousandsRegExp dateFormats dateFormatIndex dates blankDates anyBlankDates invalidDates anyInvalidDates rawNumericColumns;