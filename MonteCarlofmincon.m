...
figure(2); hold on;
subplot(2,1,1); 
histogram(cell2mat(J),100,'EdgeColor',[.6 .6 .6], 'FaceColor',[.6 .6 .6]);
subplot(2,1,2); 
...
for i = 1 : 7
   ...
   histogram(e_prop,40,'EdgeColor',[.7 .7 .7], 'FaceColor',[.6 .6 .6]); 
   hold on;
   title([TexNames{i}],'Interpreter','latex');
   leg = '40%';
   legend(leg,'Interpreter','latex'); hold off; 
end
save('MonteCarloSim3.mat','rPar','aux_i','e_flags','TexNames'); 
